...
WebUI.click(findTestObject('Object Repository/MDM_Page_Objects/Page_Oracle Fusion Cloud Applications/path_Apps_svg-outline'))
...
WebUI.click(findTestObject('Object Repository/MDM_Page_Objects/Page_Organization Organizations/li_Customer'))

WebUI.click(findTestObject('Object Repository/MDM_Page_Objects/Page_Organization Organizations/button_Search'))

WebUI.click(findTestObject('Object Repository/MDM_Page_Objects/Page_Organization Organizations/span_Test Customer'))

WebUI.click(findTestObject('Object Repository/MDM_Page_Objects/Page_Organizations/input_Active__FOpt1_FOr10_FONSr20MAnt21r10A_496570'))

WebUI.click(findTestObject('Object Repository/MDM_Page_Objects/Page_Organizations/li_No'))
