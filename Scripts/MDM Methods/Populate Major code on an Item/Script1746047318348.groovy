...
WebUI.setText(findTestObject('MDM_Page_Objects/Page_Manage Items/input_Keyword_pt1_FOr11_FONSr20MAt'), 
    'Test')
...
WebUI.click(findTestObject('Object Repository/MDM_Page_Objects/Page_Manage Items Product/a_Universal'))
