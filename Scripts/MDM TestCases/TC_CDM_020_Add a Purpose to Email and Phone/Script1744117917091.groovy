...
WebUI.callTestCase(findTestCase('MDM Methods/Add_PhoneNumber'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('MDM Methods/Add_EmailID'), [:], FailureHandling.STOP_ON_FAILURE)
