...
WebUI.click(findTestObject('Page_Transportation and Global Trade Manage_3d15c4/div_Fleet Management'))
...
WebUI.click(findTestObject('Page_Driver Finder/button_Search'))

WebUI.click(findTestObject('Page_Driver Result/a_BXC.HAROLD_HAWTHORNE_20059555'))
