...
WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Finder/input_Shipment ID_shipmentxid'))

WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Finder/button_Search'))

WebUI.doubleClick(findTestObject('Page_Buy Shipment Events Result/a_BXC.6007'))

WebUI.click(findTestObject('Object Repository/Page_Buy Shipment - Identification/body_var last_page      true    var new_rec_acd551'))
