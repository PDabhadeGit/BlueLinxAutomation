...
WebUI.click(findTestObject('Object Repository/Page_Order Releases Result/input_Domain Name_Selected'))
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Shipment Planning/select_BUFCINCLTDAVDEFAULTDFWDOMAIN_DEFAULT_695ee4'), 
    'BXC.RAIL', true)
...
WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Result/a_BXC.1000088'))

WebUI.click(findTestObject('Object Repository/Page_Buy Shipment - Identification/button_Status'))
