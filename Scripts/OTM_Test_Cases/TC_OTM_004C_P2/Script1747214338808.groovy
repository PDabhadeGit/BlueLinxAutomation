...
WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Result/span_Open Tender'))

WebUI.switchToWindowTitle('Buy Shipments Result')

WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Result/a_View All Spot Bid Options'))
