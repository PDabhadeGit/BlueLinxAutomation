...
WebUI.callTestCase(findTestCase('OTM_Methods/Search required Order'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Page_Buy Shipment - Identification/a_Financials'))
