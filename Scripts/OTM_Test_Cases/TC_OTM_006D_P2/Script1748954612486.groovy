...
WebUI.click(findTestObject('Object Repository/Bulk plan objects/Page_Buy Shipments Result/input_Domain Name_Selected'))

WebUI.click(findTestObject('Object Repository/Bulk plan objects/Page_Buy Shipments Result/button_Actions'))

WebUI.click(findTestObject('Object Repository/Bulk plan objects/Page_Buy Shipments Result/span_Shipment Management'))

WebUI.click(findTestObject('Object Repository/Bulk plan objects/Page_Buy Shipments Result/span_Change Shipment Details'))

WebUI.click(findTestObject('Object Repository/Bulk plan objects/Page_Buy Shipments Result/a_Move Order To Shipment'))

WebUI.switchToWindowIndex(3)

WebUI.setText(findTestObject('Object Repository/Bulk plan objects/Page_Move Order To Shipment/input__order_release'), 'SO_TEST646952')

WebUI.click(findTestObject('Object Repository/Bulk plan objects/Page_Move Order To Shipment/button_OK'))
