...
WebUI.click(findTestObject('Object Repository/Page_Buy Shipment - Identification/a_Equipment'))

WebUI.click(findTestObject('Object Repository/Page_Buy Shipment - Equipment/a_6002'))

WebUI.switchToWindowIndex(1)

WebUI.click(findTestObject('Object Repository/Page_Shipment Equipment/button_Status'))
