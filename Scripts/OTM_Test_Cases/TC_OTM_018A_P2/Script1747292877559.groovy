...
WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Result/span_Load Config_actionTree.1_8.o'))

WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Result/span_Tender'))

WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Result/a_Tender Shipment'))
