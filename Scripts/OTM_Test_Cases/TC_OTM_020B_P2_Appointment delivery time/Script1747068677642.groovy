...
WebUI.callTestCase(findTestCase('OTM_Methods/Appointment delivery time_1'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Page_Buy Shipment - Stops/a_Buy Shipments Result'))
