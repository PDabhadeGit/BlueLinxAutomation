...
WebUI.scrollToElement(findTestObject('Page_Buy Shipment - Financials/td_New Shipment Cost'), 1)
...
WebUI.click(findTestObject('Object Repository/Page_Buy Shipment - Financials/div_Cost Type'))
