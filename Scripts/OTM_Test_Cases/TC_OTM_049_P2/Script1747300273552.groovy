...
WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Result/span_View'))

WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Result/a_Related Shipments'))

WebUI.switchToWindowIndex(1)

WebUI.click(findTestObject('Object Repository/Page_Related Shipments/button_Go'))
