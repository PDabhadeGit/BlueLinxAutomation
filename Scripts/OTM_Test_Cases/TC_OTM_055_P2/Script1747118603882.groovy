...
WebUI.click(findTestObject('Object Repository/Page_Order Releases Finder/a_Locations'))

WebUI.setText(findTestObject('Object Repository/Page_Order Releases Finder/input_Source Location ID_order_releasesourcexid'), 
    'CUS-11756-63834')

WebUI.click(findTestObject('Object Repository/Page_Order Releases Finder/button_Search'))

WebUI.click(findTestObject('Object Repository/Page_Order Releases Result/a_BXC.SO_TEST364072'))

WebUI.click(findTestObject('Object Repository/Page_Order Release - Order Release/button_Finished'))
