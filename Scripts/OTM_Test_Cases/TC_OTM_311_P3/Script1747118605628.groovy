...
WebUI.click(findTestObject('Page_Order Releases Result/a_BXC.SO_329_3852'))

WebUI.scrollToElement(findTestObject('Page_Order Release - Order Release/span_GROSS_MARGIN_AMT'), 1)

WebUI.click(findTestObject('Object Repository/Page_Order Release - Order Release/span_GROSS_MARGIN_AMT'))

WebUI.click(findTestObject('Object Repository/Page_Order Release - Order Release/span_GROSS_MARGIN_PCT'))
