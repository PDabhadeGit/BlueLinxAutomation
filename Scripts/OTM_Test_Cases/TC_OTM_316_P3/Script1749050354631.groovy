...
WebUI.setText(findTestObject('Object Repository/Page_Order Releases Finder/input_Order Release ID_order_releasexid'), 'RO_TESTORDER')

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Order Releases Finder/select_CUSTOMER_ORDERDISTRIBUTION_ORDEREQUI_466aab'), 
    'RETURN_ORDER', true)

//WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Order Releases Finder/select_CUSTOMER_ORDERDISTRIBUTION_ORDEREQUI_466aab'), 'TRANSFER_ORDER', true)
