...
WebUI.click(findTestObject('Object Repository/Page_Order Releases Result/a_BXC.SO_329_3851'))

WebUI.click(findTestObject('Object Repository/Page_Order Release - Order Release/a__order_releasesourcexid_view'))
...
WebUI.click(findTestObject('Object Repository/Page_Order Release - Order Release/a__order_releasedestinationxid_view'))
