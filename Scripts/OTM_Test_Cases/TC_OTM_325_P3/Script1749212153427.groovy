...
WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Result/a_BXC.53281'))

WebUI.click(findTestObject('Bulk plan objects/Page_Buy Shipment - Identification/a_Stops'))
