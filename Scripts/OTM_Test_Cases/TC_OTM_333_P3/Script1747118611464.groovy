...
WebUI.click(findTestObject('Page_Transportation and Global Trade Manage_3d15c4/span_Order Release_1'))
...
WebUI.click(findTestObject('Object Repository/Page_Order Release - Order Release/a_Order Releases Result'))

WebUI.rightClick(findTestObject('Page_Order Releases Result/a_BXC.SO_329_3852'))
