...
WebUI.click(findTestObject('Object Repository/Page_Order Release - Order Release/a_Line Item'))

WebUI.click(findTestObject('Object Repository/Page_Order Release - Line Item/span_4003'))
