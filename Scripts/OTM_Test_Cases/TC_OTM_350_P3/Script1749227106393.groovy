...
WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Result/input_BXC.7014_Selected'))
...
WebUI.click(findTestObject('Object Repository/Page_Secure Resources/button_Refresh'))

WebUI.switchToWindowTitle('Buy Shipments Result')

WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Result/span_Transportation and Global Trade Manage_f1b5a4'))
...
WebUI.click(findTestObject('Object Repository/Page_Transportation and Global Trade Manage_3d15c4/span_Integration'))

WebUI.click(findTestObject('Object Repository/Page_Transportation and Global Trade Manage_3d15c4/span_Transmission Manager'))

WebUI.click(findTestObject('Object Repository/Page_Transmissions Finder/button_Search'))

WebUI.click(findTestObject('Object Repository/Page_Transmissions Result/a_991948'))
