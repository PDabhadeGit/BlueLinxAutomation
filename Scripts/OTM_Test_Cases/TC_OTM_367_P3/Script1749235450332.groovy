...
WebUI.click(findTestObject('Page_Transportation and Global Trade Manage_3d15c4/span_Buy Shipment'))

WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Finder/button_Search'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Result/a_BXC.6007'))

WebUI.click(findTestObject('Object Repository/Page_Buy Shipment - Identification/a_Buy Shipments Result'))

WebUI.delay(5)

WebUI.rightClick(findTestObject('Object Repository/Page_Buy Shipments Result/a_BXC.8000'))

WebUI.click(findTestObject('Object Repository/Page_Buy Shipments Result/a_Status'))

WebUI.click(findTestObject('Object Repository/Page_Statuses/a_Buy Shipments Result'))

WebUI.click(findTestObject('Page_Buy Shipments Result/input_BXC.8000_Selected'))
