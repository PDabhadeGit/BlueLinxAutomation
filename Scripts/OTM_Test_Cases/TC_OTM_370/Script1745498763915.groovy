...
WebUI.click(findTestObject('Object Repository/Page_Transportation and Global Trade Manage_3d15c4/span_Voucher'))

WebUI.click(findTestObject('Object Repository/Page_Vouchers Finder/button_Search'))

WebUI.click(findTestObject('Object Repository/Page_Vouchers Result/a_BXC.20250313-0002'))
